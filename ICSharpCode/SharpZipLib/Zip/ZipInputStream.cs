  ...
  public class ZipInputStream : InflaterInputStream
  {
    ...
    public void CloseEntry()
    {
      ...
      else
      {
        ...
        long num1;
        for (; this.csize != 0L; zipInputStream.csize = num1)
        {
          long num2 = this.Skip(this.csize);
          if (num2 <= 0L)
            throw new ZipException("Zip archive ends early.");
          zipInputStream = this;
          num1 = zipInputStream.csize - num2;
        }
      }
        ...
        case 8:
          ...
          if (count <= 0)
          {
            ...
            if ((this.flags & 8) == 0 && (this.inf.TotalIn != this.csize && this.csize != (long) uint.MaxValue && this.csize != -1L || this.inf.TotalOut != this.size))
              throw new ZipException("Size mismatch: " + (object) this.csize + ";" + (string) (object) this.size + " <-> " + (string) (object) this.inf.TotalIn + ";" + (string) (object) this.inf.TotalOut);
            this.inf.Reset();
            flag = true;
            break;
          }
