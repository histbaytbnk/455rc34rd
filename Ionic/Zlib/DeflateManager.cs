  ...
  internal sealed class DeflateManager
  {
    ...
    internal static bool _IsSmaller(short[] tree, int n, int m, sbyte[] depth)
    {
      ...
      if ((int) num1 < (int) num2)
        return true;
      if ((int) num1 == (int) num2)
        return (int) depth[n] <= (int) depth[m];
      return false;
    }
...
label_26:
    ...
    internal int longest_match(int cur_match)
    {
      ...
      do
      {
        ...
        int num9;
        if ((int) this.window[index2 + num2] == (int) num8 && (int) this.window[index2 + num2 - 1] == (int) num7 && ((int) this.window[index2] == (int) this.window[index1] && (int) this.window[num9 = index2 + 1] == (int) this.window[index1 + 1]))
        {
          int num10 = index1 + 2;
          int num11 = num9 + 1;
          int num12;
          ...
          do
            ;
          while ((int) this.window[++num10] == (int) this.window[num12 = num11 + 1] && (int) this.window[++num10] == (int) this.window[num13 = num12 + 1] && ((int) this.window[++num10] == (int) this.window[num14 = num13 + 1] && (int) this.window[++num10] == (int) this.window[num15 = num14 + 1]) && ((int) this.window[++num10] == (int) this.window[num16 = num15 + 1] && (int) this.window[++num10] == (int) this.window[num17 = num16 + 1] && ((int) this.window[++num10] == (int) this.window[num18 = num17 + 1] && (int) this.window[++num10] == (int) this.window[num11 = num18 + 1])) && num10 < num6);
          int num19 = DeflateManager.MAX_MATCH - (num6 - num10);
