...
namespace BrightIdeasSoftware
{
  public class ColumnSelectionForm : Form
  {
    ...
    protected void InitializeForm(ObjectListView olv, View view)
    {
      ...
      foreach (OLVColumn index in this.RearrangableColumns)
        this.MapColumnToVisible[index] = view != View.Details ? index.IsTileViewColumn : index.IsVisible;
      ...
      {
        OLVColumn index = (OLVColumn) rowObject;
        if (!index.CanBeHidden)
          return true;
        this.MapColumnToVisible[index] = newValue;
        this.EnableControls();
        return newValue;
      });
    ...
    protected void Apply(ObjectListView olv, View view)
    {
      ...
      {
        foreach (OLVColumn index in olv.AllColumns)
          index.IsVisible = this.MapColumnToVisible[index];
      }
      else
      {
        foreach (OLVColumn index in olv.AllColumns)
          index.IsTileViewColumn = this.MapColumnToVisible[index];
      }
      ...
      {
        OLVColumn olvColumn = this.AllColumns[0];
        all.Remove(olvColumn);
        olv.Columns.Clear();
        olv.Columns.Add((ColumnHeader) olvColumn);
    ...
    {
      int index = this.objectListView1.SelectedIndices[0];
      OLVColumn olvColumn = this.RearrangableColumns[index];
      this.RearrangableColumns.RemoveAt(index);
      this.RearrangableColumns.Insert(index - 1, olvColumn);
    ...
    protected void EnableControls()
    {
      ...
      else
      {
        ...
        OLVColumn index = (OLVColumn) this.objectListView1.SelectedObject;
        this.buttonShow.Enabled = !this.MapColumnToVisible[index] && index.CanBeHidden;
        this.buttonHide.Enabled = this.MapColumnToVisible[index] && index.CanBeHidden;
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.buttonMoveUp.Location = new Point(295, 31);
      this.buttonMoveUp.Name = "buttonMoveUp";
      this.buttonMoveUp.Size = new Size(87, 23);
      ...
      this.buttonMoveDown.Location = new Point(295, 60);
      this.buttonMoveDown.Name = "buttonMoveDown";
      this.buttonMoveDown.Size = new Size(87, 23);
      ...
      this.buttonShow.Location = new Point(295, 89);
      this.buttonShow.Name = "buttonShow";
      this.buttonShow.Size = new Size(87, 23);
      ...
      this.buttonHide.Location = new Point(295, 118);
      this.buttonHide.Name = "buttonHide";
      this.buttonHide.Size = new Size(87, 23);
      ...
      this.label1.Size = new Size(366, 19);
      this.label1.TabIndex = 5;
      this.label1.Text = "Choose the columns you want to see in this list. ";
      this.buttonOK.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
      this.buttonOK.Location = new Point(198, 304);
      this.buttonOK.Name = "buttonOK";
      this.buttonOK.Size = new Size(87, 23);
      ...
      this.buttonCancel.Location = new Point(295, 304);
      this.buttonCancel.Name = "buttonCancel";
      this.buttonCancel.Size = new Size(87, 23);
      ...
      this.objectListView1.Location = new Point(12, 31);
      this.objectListView1.MultiSelect = false;
      this.objectListView1.Name = "objectListView1";
      this.objectListView1.ShowGroups = false;
      this.objectListView1.ShowSortIndicators = false;
      this.objectListView1.Size = new Size(273, 259);
      ...
      this.ClientSize = new Size(391, 339);
