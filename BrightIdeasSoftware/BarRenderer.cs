...
namespace BrightIdeasSoftware
{
  public class BarRenderer : BaseRenderer
  {
    ...
    public Brush Brush
    {
      get
      {
        if (this.brush == null && !this.FillColor.IsEmpty)
          return (Brush) new SolidBrush(this.FillColor);
        return this.brush;
      }
      set
      {
    ...
    public Brush BackgroundBrush
    {
      get
      {
        if (this.backgroundBrush == null && !this.BackgroundColor.IsEmpty)
          return (Brush) new SolidBrush(this.BackgroundColor);
    ...
    public override void Render(Graphics g, Rectangle r)
    {
      ...
      if (convertible == null)
        return;
      double num = convertible.ToDouble((IFormatProvider) NumberFormatInfo.InvariantInfo);
