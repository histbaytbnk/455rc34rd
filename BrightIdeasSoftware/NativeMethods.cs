...
namespace BrightIdeasSoftware
{
  internal static class NativeMethods
  {
    ...
    public static extern IntPtr SendMessageLVItem(IntPtr hWnd, int msg, int wParam, ref NativeMethods.LVITEM lvi);

    [DllImport("user32.dll", CharSet = CharSet.Auto)]
    public static extern IntPtr SendMessage(IntPtr hWnd, int msg, int wParam, ref NativeMethods.LVHITTESTINFO ht);

    [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
    public static extern IntPtr SendMessageRECT(IntPtr hWnd, int msg, int wParam, ref NativeMethods.RECT r);

    [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
    private static extern IntPtr SendMessageHDItem(IntPtr hWnd, int msg, int wParam, ref NativeMethods.HDITEM hdi);

    [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
    public static extern IntPtr SendMessageHDHITTESTINFO(IntPtr hWnd, int Msg, IntPtr wParam, [In, Out] NativeMethods.HDHITTESTINFO lParam);
    ...
    public static bool DrawImage(ImageList il, IntPtr hdc, int index, int x, int y, NativeMethods.ImageListDrawItemConstants flags, int cx, int cy, NativeMethods.ImageListDrawStateConstants stateFlags)
    {
    ...
    {
      NativeMethods.SetItemState(list, index, 2, 0);
    }
    ...
    public static int GetWindowLong(IntPtr hWnd, int nIndex)
    {
      ...
      return (int) (long) NativeMethods.GetWindowLongPtr64(hWnd, nIndex);
    }
    ...
    public static int SetWindowLong(IntPtr hWnd, int nIndex, int dwNewLong)
    {
      ...
      return (int) (long) NativeMethods.SetWindowLongPtr64(hWnd, nIndex, dwNewLong);
    }
    ...
    {
      NativeMethods.SendMessage(virtualObjectListView.Handle, 4256, 0, 0);
    }
