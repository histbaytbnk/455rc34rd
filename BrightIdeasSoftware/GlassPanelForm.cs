  ...
  internal class GlassPanelForm : Form
  {
    ...
    public void Bind(ObjectListView olv, IOverlay overlay)
    {
      ...
      foreach (Control control in this.ancestors)
      {
        ...
        if (tabControl != null)
          tabControl.Selected += new TabControlEventHandler(this.tabControl_Selected);
      }
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      ...
      if (this.mdiClient != null)
      {
        Rectangle rect = this.objectListView.RectangleToClient(this.mdiClient.RectangleToScreen(this.mdiClient.ClientRectangle));
    ...
    internal void UpdateTransparency()
    {
      ...
      if (transparentOverlay == null)
        ...
        this.Opacity = (double) transparentOverlay.Transparency / (double) byte.MaxValue;
    }
