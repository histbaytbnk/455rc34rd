...
namespace PS3SaveEditor
{
  public class UpgradeDownloader : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.pbProgress.Location = new Point(8, 56);
      this.pbProgress.Name = "pbProgress";
      this.pbProgress.Size = new Size(409, 23);
      this.pbProgress.TabIndex = 0;
      this.lblStatus.AutoSize = true;
      this.lblStatus.ForeColor = Color.White;
      this.lblStatus.Location = new Point(10, 39);
      this.lblStatus.Name = "lblStatus";
      this.lblStatus.Size = new Size(143, 13);
      ...
      this.panel1.Size = new Size(432, 131);
      this.panel1.TabIndex = 2;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.BackColor = Color.Black;
      this.ClientSize = new Size(452, 155);
      this.Controls.Add((Control) this.panel1);
      this.FormBorderStyle = FormBorderStyle.Fixed3D;
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.Name = "UpgradeDownloader";
      this.ShowIcon = false;
