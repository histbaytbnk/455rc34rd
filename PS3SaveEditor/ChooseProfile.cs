...
namespace PS3SaveEditor
{
  public class ChooseProfile : Form
  {
    ...
    public ChooseProfile(Dictionary<string, object> accounts, string curProfile)
    {
      ...
      foreach (string index in accounts.Keys)
      {
        if (!(index == curProfile))
          list.Add(new ProfileItem()
          {
            PSNID = index,
            Name = (accounts[index] as Dictionary<string, object>)["friendly_name"] as string
          });
      }
      this.cbProfiles.DisplayMember = "Name";
      this.cbProfiles.ValueMember = "PSNID";
      this.cbProfiles.DataSource = (object) list;
    ...
    private void InitializeComponent()
    {
      ...
      this.panel1.Size = new Size(246, 68);
      this.panel1.TabIndex = 3;
      this.btnCancel.DialogResult = DialogResult.Cancel;
      this.btnCancel.Location = new Point(135, 39);
      ...
      this.btnSelect.Location = new Point(37, 38);
      ...
      this.cbProfiles.Location = new Point(37, 10);
      this.cbProfiles.Name = "cbProfiles";
      this.cbProfiles.Size = new Size(173, 21);
      this.cbProfiles.TabIndex = 3;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(266, 88);
      this.Controls.Add((Control) this.panel1);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.Name = "ChooseProfile";
